...
main_script="$HOME/eman/bash_scripts/run_tosca_main.sh"
slurm_log_dir="$HOME/eman/experiment_outputs/tosca_main_exp_logs"
notify_email=""
partition="gpu"
    ...
    for model in "${model_types[@]}"; do
        for reltan in "${use_reltan[@]}"; do
            ...
            for rpl in "${rpls[@]}"; do
                ...
                sbatch --job-name eman-$clean_job_name --time=3:30:00 \
